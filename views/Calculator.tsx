...
document.addEventListener('alpine:init', () => {
  ...
  return html`
    <div x-data="calculator">
      ...
      <nav>
        <ul>
          <li><strong><span x-text="t('title')"></span></strong></li>
        </ul>
        <ul>
          <li>
            <button
      ...
      <div class="responsive-grid">
        ...
        <article class="card-content">
          <header><h3 x-text="t('currentValues')"></h3></header>

          <label>
            <span x-text="t('stockPrice')"></span>
            <input type="number" x-model.number="stockPrice">
          </label>

          <label>
            <span x-text="t('currentPer')"></span>
            <input type="number" x-model.number="currentPer" step="0.1">
          </label>

          <label>
            <span x-text="t('currentPbr')"></span>
            <input type="number" x-model.number="currentPbr" step="0.01">
          </label>

          <label>
            <span x-text="t('currentYield')"></span>
            <input type="number" x-model.number="currentYield" step="0.1">
          </label>
        </article>

        <!-- Column 2: Targets (Sliders + Inputs) -->
        <article class="card-content">
          <header><h3 x-text="t('targetValues')"></h3></header>

          <!-- Target PER -->
          <label>
            <div class="grid">
              <span x-text="t('targetPer')"></span>
              <input
                type="number"
          ...
          <label>
            <div class="grid">
              <span x-text="t('targetYield')"></span>
              <input
                type="number"
        ...
        <!-- Column 3: Results -->
        <article class="card-content">
          <header><h3 x-text="t('results')"></h3></header>
          ...
          >
            <strong x-text="t('finalPrice')"></strong>
            ...
            <div x-show="results.minPrice !== null">
              ...
              >
                <span x-text="t('bottleneckDesc')"></span>:
